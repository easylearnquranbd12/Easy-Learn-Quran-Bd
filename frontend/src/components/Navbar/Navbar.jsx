...
const getNavigationLinks = (user, setLanguage) => {
  const baseLinks = [
    { title: "Home", link: "/" },
...
const Navbar = () => {
  ...
  const { setLanguage, loading } = useTranslation(); // Translation context
  useEffect(() => {
  ...
  const navigationLinks = getNavigationLinks(user, setLanguage);
