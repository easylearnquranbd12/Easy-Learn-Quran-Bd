...
const pastPapers = [
  ...
  { title: "Mar / Apr", path: "/past-paper/a-level/Mathematics/march-april" },
  { title: "May / Jun", path: "/past-paper/a-level/Mathematics/may-june" },
  { title: "Jul / Aug", path: "/past-paper/a-level/Mathematics/july-august" },
  {
    title: "Sep / Oct",
...
const PastPaperAlevelMathematics = () => {
  return (
    <div className="py-3">
      <Helmet>
        <title>Past Papers | A-Level-Mathematics</title>
      </Helmet>
      <TittleAnimation tittle="Past Paper A Level" subtittle="Mathematics" />
...
export default PastPaperAlevelMathematics;
