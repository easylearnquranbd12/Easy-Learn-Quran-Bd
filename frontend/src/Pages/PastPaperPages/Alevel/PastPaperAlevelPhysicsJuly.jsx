...
const PastPaperAlevelPhysicsJuly = () => {
  return (
    <>
      <Helmet>
      ...
      <div className="py-3 px-3 max-w-7xl mx-auto">
        ...
        <Section
          title="Question Papers July / August"
          items={[
            {
        ...
        <Section
          title="Mark Schemes July / August"
          items={[
...
export default PastPaperAlevelPhysicsJuly;
