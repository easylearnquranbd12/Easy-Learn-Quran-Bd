...
const PastPaperAlevelChemistrySeptember = () => {
  return (
    <>
      <Helmet>
        <title>Chemistry | Additional Papers</title>
      </Helmet>

      <div className="py-3 px-3">
        <TittleAnimation
          tittle="Additional Chemistry"
        ...
        <Section
          title="Mark Schemes September / October max-w-7xl mx-auto"
          items={[
            ...
            { label: "Mark Scheme 44", url: "https://example.com/ms22.pdf" },
          ]}
          custom={5}
          color="green"
        />
...
export default PastPaperAlevelChemistrySeptember;
