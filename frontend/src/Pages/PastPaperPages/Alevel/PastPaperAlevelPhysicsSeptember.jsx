...
const PastPaperAlevelPhysicsSeptember = () => {
  return (
    <>
      <Helmet>
      ...
      <div className="py-3 px-3 max-w-7xl mx-auto">
        <TittleAnimation
          tittle="Additional Physics"
          subtittle="September / October"
        />
        ...
        <Section
          title="Question Papers September / October"
          items={[
            {
        ...
        <Section
          title="Mark Schemes  September / October"
          items={[
        ...
        <Section
          title="Others  September / October"
          items={[
            {
...
export default PastPaperAlevelPhysicsSeptember;
