...
const Section = ({ title, items, custom, color }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`rounded-lg p-4 border ${styles.bg} ${styles.border} shadow-sm`}
      >
...
const PastPaperAlevelPhysicsMay = () => {
  return (
    <>
      <Helmet>
        <title>Physics | Additional Papers</title>
      </Helmet>

      <div className="py-3 px-3 max-w-7xl mx-auto">
        <TittleAnimation tittle="Additional Physics" subtittle=" May / June" />
        ...
        <Section
          title="Question Papers May / June"
          items={[
            {
            ...
            {
              label: "Question Paper 33",
              url: "https://example.com/paper21.pdf",
            },
            {
              label: "Question Paper 42",
              url: "https://example.com/paper22.pdf",
            },
            {
              label: "Question Paper 52",
              url: "https://example.com/paper22.pdf",
            },
          ]}
          custom={4}
        ...
        <Section
          title="Mark Schemes May / June"
          items={[
            { label: "Mark Scheme 12", url: "https://example.com/ms11.pdf" },
            { label: "Mark Scheme 22", url: "https://example.com/ms12.pdf" },
            { label: "Mark Scheme 33", url: "https://example.com/ms21.pdf" },
            { label: "Mark Scheme 42", url: "https://example.com/ms22.pdf" },
            { label: "Mark Scheme 52", url: "https://example.com/ms22.pdf" },
          ]}
          custom={5}
          color="green"
        />
...
export default PastPaperAlevelPhysicsMay;
