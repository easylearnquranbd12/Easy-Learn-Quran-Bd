...
const PastPaperAlevelPhysicsNovember = () => {
  return (
    <>
      <Helmet>
      ...
      <div className="py-3 px-3 max-w-7xl mx-auto">
        ...
        <Section
          title="Question Papers November / December"
          items={[
            {
        ...
        <Section
          title="Mark Schemes November / December"
          items={[
        ...
        <Section
          title="Others November / December"
          items={[
            {
...
export default PastPaperAlevelPhysicsNovember;
