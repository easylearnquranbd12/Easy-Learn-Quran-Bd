...
const PastPaperOlevelMathematicsSeptember = () => {
  return (
    <>
      <Helmet>
        <title>Mathematics | Additional Papers</title>
      </Helmet>
      ...
      <div className="py-3 px-3 max-w-7xl mx-auto">
        ...
        <Section
          title="Question PapersSeptember / October"
          items={[
            {
        ...
        <Section
          title="Mark SchemesSeptember / October"
          items={[
...
export default PastPaperOlevelMathematicsSeptember;
