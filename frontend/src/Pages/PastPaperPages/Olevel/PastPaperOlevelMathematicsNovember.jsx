...
const PastPaperOlevelMathematicsNovember = () => {
  return (
    <>
      <Helmet>
      ...
      <div className="py-3 px-3 max-w-7xl mx-auto">
        ...
        <Section
          title="Question PapersNovember / December"
          items={[
            {
        ...
        <Section
          title="Mark SchemesNovember / December"
          items={[
...
export default PastPaperOlevelMathematicsNovember;
