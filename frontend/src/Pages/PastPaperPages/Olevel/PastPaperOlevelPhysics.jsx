...
const pastPapers = [
  ...
  { title: "Mar / Apr", path: "/past-paper/o-level/physics/march-april" },
  { title: "May / Jun", path: "/past-paper/o-level/physics/may-june" },
  { title: "Jul / Aug", path: "/past-paper/o-level/physics/july-august" },
  {
    title: "Sep / Oct",
...
const PastPaperOlevelPhysics = () => {
  return (
    <div className="py-3">
      <Helmet>
        <title>Past Papers | O-Level-Physics</title>
      </Helmet>
      <TittleAnimation tittle="Past Paper O Level" subtittle="Physics" />
...
export default PastPaperOlevelPhysics;
