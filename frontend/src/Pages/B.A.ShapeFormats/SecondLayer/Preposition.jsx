...
const Preposition = () => {
  ...
  const { mutateAsync: createprepositionExercise } = useMutation({
    mutationFn: async (newData) => {
      const res = await axiosPublic.post(
        "/second-layer/createExercisepreposition",
        newData,
      );
      return res.data;
    },
  ...
  if (!data) return <p className="text-center mt-10">No preposition data found.</p>;
  ...
  const onSubmit = async (data) => {
    ...
    createprepositionExercise(payload);
    reset();
  };
                      ...
                      <table className="table w-full">
                        ...
                        <tbody>
                          <tr>
                            ...
                            {prepositionFields?.[0]?.mainWord !== "no" &&
                              prepositionFields?.[0]?.mainWord !== "none" && (
                                <td>
                                  <textarea
                                    {...register("mainWord")}
                            ...
                            {prepositionFields?.[0]?.banglaPronunciation !== "no" &&
                              prepositionFields?.[0]?.banglaPronunciation !==
                                "none" && (
                                <td>
                                  <textarea
                            ...
                            {prepositionFields?.[0]?.banglaMeaning !== "no" &&
                              prepositionFields?.[0]?.banglaMeaning !== "none" && (
                                <td>
                                  <textarea
                            ...
                            {prepositionFields?.[0]?.synonyms !== "no" &&
                              prepositionFields?.[0]?.synonyms !== "none" && (
                                <td>
                                  <textarea
                                    {...register("synonyms")}
                                    className="input input-base  w-72 md:w-96 min-h-20 cursor-text bg-white text-black border border-gray-300 focus:outline-none focus:ring-0 focus:border-green-300 rounded-md"
                            ...
                            {prepositionFields?.[0]?.antonyms !== "no" &&
                              prepositionFields?.[0]?.antonyms !== "none" && (
                                <td>
                                  <textarea
                                    {...register("antonyms")}
                                    className="input input-base  w-72 md:w-96 min-h-20 cursor-text bg-white text-black border border-gray-300 focus:outline-none focus:ring-0 focus:border-green-300 rounded-md"
                            ...
                            {prepositionFields?.[0]?.exampleEnglish !== "no" &&
                              prepositionFields?.[0]?.exampleEnglish !== "none" && (
                                <td>
                                  <textarea
                            ...
                            {prepositionFields?.[0]?.exampleBangla !== "no" &&
                              prepositionFields?.[0]?.exampleBangla !== "none" && (
                                <td>
                                  <textarea
