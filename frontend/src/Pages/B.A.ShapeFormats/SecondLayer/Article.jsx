...
const Article = () => {
  ...
  const { data: articleFields = [], isLoading: fieldLoading } = useQuery({
  ...
  const { mutateAsync: createarticleExercise } = useMutation({
    mutationFn: async (newData) => {
      const res = await axiosPublic.post(
        "/second-layer/createExercisearticle",
        newData,
      );
      return res.data;
    },
  ...
  if (fieldLoading || articleLoading) return <CustomLoading />;

  const articleField = articleFields[0] || {};
  const data = article[0] || {};

  if (!data) return <p className="text-center mt-10">No article data found.</p>;

  // Dynamic tab generation
  const tabs = [
    { id: "mainWord", label: articleField.mainWord },
    { id: "banglaPronunciation", label: articleField.banglaPronunciation },
    { id: "banglaMeaning", label: articleField.banglaMeaning },
    { id: "synonyms", label: articleField.synonyms },
    { id: "antonyms", label: articleField.antonyms },
    { id: "exampleEnglish", label: articleField.exampleEnglish },
    { id: "exampleBangla", label: articleField.exampleBangla },
  ];
                      ...
                      <table className="table w-full">
                        ...
                        <tbody>
                          <tr>
                            ...
                            {articleFields?.[0]?.mainWord !== "no" &&
                              articleFields?.[0]?.mainWord !== "none" && (
                                <td>
                                  <textarea
                                    {...register("mainWord")}
                            ...
                            {articleFields?.[0]?.banglaPronunciation !== "no" &&
                              articleFields?.[0]?.banglaPronunciation !==
                                "none" && (
                                <td>
                                  <textarea
                            ...
                            {articleFields?.[0]?.banglaMeaning !== "no" &&
                              articleFields?.[0]?.banglaMeaning !== "none" && (
                                <td>
                                  <textarea
                            ...
                            {articleFields?.[0]?.synonyms !== "no" &&
                              articleFields?.[0]?.synonyms !== "none" && (
                                <td>
                                  <textarea
                                    {...register("synonyms")}
                                    className="input input-base  w-72 md:w-96 min-h-20 cursor-text bg-white text-black border border-gray-300 focus:outline-none focus:ring-0 focus:border-green-300 rounded-md"
                            ...
                            {articleFields?.[0]?.antonyms !== "no" &&
                              articleFields?.[0]?.antonyms !== "none" && (
                                <td>
                                  <textarea
                                    {...register("antonyms")}
                                    className="input input-base  w-72 md:w-96 min-h-20 cursor-text bg-white text-black border border-gray-300 focus:outline-none focus:ring-0 focus:border-green-300 rounded-md"
                            ...
                            {articleFields?.[0]?.exampleEnglish !== "no" &&
                              articleFields?.[0]?.exampleEnglish !== "none" && (
                                <td>
                                  <textarea
                            ...
                            {articleFields?.[0]?.exampleBangla !== "no" &&
                              articleFields?.[0]?.exampleBangla !== "none" && (
                                <td>
                                  <textarea
