...
const DevelopYourSkills = () => {
  ...
  // ✅ Fetch song fields
  const { data: developFields = [], isLoading: fieldsLoading } = useQuery({
    queryKey: ["developFields"],
    queryFn: async () => {
  ...
  const { data: develop = [], isLoading: songsLoading } = useQuery({
    queryKey: ["develop"],
    queryFn: async () => {
