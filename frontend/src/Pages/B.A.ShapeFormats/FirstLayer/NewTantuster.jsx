...
const Newtantuster = () => {
  ...
  if (!data) return <p className="text-center mt-10">No newtantuster data found.</p>;
                      ...
                      <table className="table w-full">
                        ...
                        <tbody>
                          <tr>
                            ...
                            {newtantusterFields?.[0]?.banglaPronunciation !== "no" &&
                            ...
                            {newtantusterFields?.[0]?.banglaMeaning !== "no" &&
                              newtantusterFields?.[0]?.banglaMeaning !== "none" && (
                                <td>
                                  <textarea
                            ...
                            {newtantusterFields?.[0]?.exampleEnglish !== "no" &&
                              newtantusterFields?.[0]?.exampleEnglish !== "none" && (
                                <td>
                                  <textarea
                            ...
                            {newtantusterFields?.[0]?.exampleBangla !== "no" &&
                              newtantusterFields?.[0]?.exampleBangla !== "none" && (
                                <td>
                                  <textarea
