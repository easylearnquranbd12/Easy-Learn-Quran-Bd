...
//     );
//   }
//   console.log("story", storyWriting);
//   return (
//     <div className="min-h-screen  py-10 p-2  md:px-10">
//       {/* Section Header */}
...
//               {/* Footer */}
//               <div className="flex justify-between mt-12 text-xs md:text-sm text-[#3e2c1c]">
//                 <span>✍ {page.writtingBy}</span>
//                 <span>~ {formatDate(page.createdAt)}</span>
//               </div>

//               <div className="text-center mt-6 text-xs text-[#3e2c1c]">
