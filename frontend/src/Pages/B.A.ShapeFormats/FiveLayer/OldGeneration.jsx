...
const OldGeneration = () => {
  ...
  // ✅ Fetch song fields
  const { data: oldGenerationFields = [], isLoading: fieldsLoading } = useQuery({
  ...
  const { data: oldGeneration = [], isLoading: songsLoading } = useQuery({
