...
//       refetchelegant(); // Refetch the list after deletion
//     },
//     onError: (error) => {
...
//       {/* History */}
//       <div className="bg-white rounded-lg shadow-md p-5 mt-10 w-[450px] md:w-[750px] lg:w-full">
//         <h1 className="mb-5">
//           Total Elegant Items:{" "}
//           <span className="text-3xl font-bold ">{elegantData.total}</span>
//         </h1>
...
const AdminElegant = () => {
  ...
  useEffect(() => {
    if (paginationRef.current && !isPageChanging) {
      ...
      const shouldScrollToPagination = sessionStorage.getItem('scrollToPagination');
