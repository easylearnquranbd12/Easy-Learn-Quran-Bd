...
const MoveFormatModal = ({ isOpen, onClose, fieldName, currentValue, vocabId }) => {
  ...
  const mutation = useMutation({
    mutationFn: async (newValue) => {
      const res = await fetch(
        `https://api.betheshape.com/seven-layer/goodMovieField/${vocabId}`,
        {
          method: "PUT",
...
export default MoveFormatModal;
