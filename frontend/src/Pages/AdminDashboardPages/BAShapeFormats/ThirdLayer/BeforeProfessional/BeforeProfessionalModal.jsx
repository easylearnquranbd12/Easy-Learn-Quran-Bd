...
const BeforeProfessionalModal = ({ isOpen, onClose, fieldName, currentValue, vocabId }) => {
  ...
  const mutation = useMutation({
    mutationFn: async (newValue) => {
      const res = await fetch(
        `https://learning-quiz-platfrom-paid-project-ten.vercel.app/third-layer/beforeProfessionalField/${vocabId}`,
        {
          method: "PUT",
...
export default BeforeProfessionalModal;
