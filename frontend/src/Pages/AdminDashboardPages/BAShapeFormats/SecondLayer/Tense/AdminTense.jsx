...
const AdminTense = () => {
  ...
  const { mutateAsync: createtense } = useMutation({
    mutationFn: async (newData) => {
      const res = await axiosPublic.post("/second-layer/tense", newData);
      return res.data;
    },
    onSuccess: () => {
  ...
  const { mutateAsync: deletetense } = useMutation({
    mutationFn: async (id) => {
      const res = await axiosPublic.delete(`/second-layer/tense/${id}`);
      return res.data;
    },
    onSuccess: () => {
  ...
  const toggleIsActiveMutation = useMutation({
    mutationFn: async (currentState) => {
      const res = await axiosPublic.put(`/second-layer/tenseField/toggle`, {
