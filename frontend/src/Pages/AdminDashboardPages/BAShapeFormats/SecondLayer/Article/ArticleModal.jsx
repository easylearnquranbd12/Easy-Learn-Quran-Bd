...
const ArticleModal = ({ isOpen, onClose, fieldName, currentValue, vocabId }) => {
  ...
  const mutation = useMutation({
    mutationFn: async (newValue) => {
      const res = await fetch(
        `https://learning-quiz-platfrom-paid-project-ten.vercel.app/second-layer/articleField/${vocabId}`,
        {
          method: "PUT",
