...
const AdminTestimonial = () => {
  ...
  const createMutation = useMutation({
    mutationFn: (data) => axiosPublic.post("/testimonials", data),
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => axiosPublic.delete(`/testimonials/${id}`),
    onSuccess: () => {
  ...
  return (
    <div>
      <TittleAnimation
        tittle="Create Testimonial"
        subtittle="Manage Testimonials"
      />
