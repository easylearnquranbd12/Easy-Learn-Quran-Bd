...
const AlevelChemistryA3 = () => {
  ...
  return (
    <div className="py-3">
      <Helmet>
        <title>Nasmatics | A-Level-Physics-A3</title>
      </Helmet>

      <TittleAnimation tittle="Resources A Level " subtittle="Chemistry A3" />
...
export default AlevelChemistryA3;
