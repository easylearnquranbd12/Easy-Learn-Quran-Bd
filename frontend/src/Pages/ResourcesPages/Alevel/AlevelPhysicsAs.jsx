...
const AlevelPhysicsAs = () => {
  ...
  return (
    <div className="py-3">
      <Helmet>
        <title>Nasmatics | A-Level-Physics-A2</title>
      </Helmet>
      <TittleAnimation tittle="Resources A Level  " subtittle="Physics AS" />
...
export default AlevelPhysicsAs;
