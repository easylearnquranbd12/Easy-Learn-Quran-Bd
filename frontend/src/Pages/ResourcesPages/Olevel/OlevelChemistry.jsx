...
const OlevelChemistry = () => {
  ...
  return (
    <div className="py-3">
      <Helmet>
        <title>Nasmatics | O-Level-Chemistry</title>
      </Helmet>
      <TittleAnimation tittle="Resources O Level" subtittle="Chemistry" />
...
export default OlevelChemistry;
